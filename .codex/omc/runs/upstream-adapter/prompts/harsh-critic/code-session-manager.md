...
- Suite: harsh-critic
- Codex role: critic
- Source fixture: _source/oh-my-claudecode/benchmarks/harsh-critic/fixtures/code/code-session-manager.ts
- Ground truth: _source/oh-my-claudecode/benchmarks/harsh-critic/ground-truth/code-session-manager.json
