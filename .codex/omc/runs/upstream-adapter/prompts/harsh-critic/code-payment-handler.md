...
- Suite: harsh-critic
- Codex role: critic
- Source fixture: _source/oh-my-claudecode/benchmarks/harsh-critic/fixtures/code/code-payment-handler.ts
- Ground truth: _source/oh-my-claudecode/benchmarks/harsh-critic/ground-truth/code-payment-handler.json
