...
const runtimePolicyChecks = [
  ...
  ["skills/omc-team/SKILL.md", "Staged Pipeline"],
  ["skills/omc-team/SKILL.md", "max_fix_loops"],
  ["skills/omc-team/SKILL.md", ".codex/omc/runs/<run-id>/handoffs"],
  ["skills/omc-team/SKILL.md", "team 20 worker medium"],
  ["skills/omc-team/SKILL.md", "reasoning_effort: medium"],
  ["skills/omc-team/SKILL.md", "team 5 worker high"],
  ["skills/omc-team/SKILL.md", "unspecified/runtime default"],
  ["skills/omc-team/SKILL.md", "Worker Intelligence And Coordination Policy"],
  ["skills/omc-team/SKILL.md", "peer artifact"],
  ["skills/omc-runtime-policy/SKILL.md", "unspecified/runtime default"],
  ["skills/omc-runtime-policy/SKILL.md", "Peer artifacts or handoffs read"],
  ["README.md", "team 20 worker"],
  ["README.md", "runtime default"],
  ["skills/omc-ultrawork/SKILL.md", "context mode"],
  ["skills/omc-ultrawork/SKILL.md", "Lane Template"],
  ["skills/omc-ralph/SKILL.md", "polite-stop"],
  ["skills/omc-ralph/SKILL.md", ".codex/omc/prd"],
  ["skills/omc-ralph/SKILL.md", "boulder_active"],
  ["skills/omc-trace/SKILL.md", "Evidence Strength Hierarchy"],
  ["skills/omc-trace/SKILL.md", "Rebuttal Round"],
  ...
  ["scripts/omc-orchestrator.mjs", "OMC Orchestrator V1"],
  ["scripts/omc-orchestrator.mjs", "manifest.json"],
  ["scripts/omc-orchestrator.mjs", "Completion gates failed"],
  ["scripts/omc-orchestrator.mjs", "packet --run"],
  ["scripts/omc-orchestrator.mjs", "Preserved existing agent artifact"],
  ["scripts/omc-orchestrator.mjs", "missing required stage"],
  ["scripts/omc-orchestrator.mjs", "fix_loop_count"],
  ["skills/omc-team/SKILL.md", "node $omc start --mode team"],
  ["skills/omc-team/SKILL.md", "node $omc packet"],
  ["skills/omc-team/SKILL.md", "node $omc fix"],
  ["skills/omc-team/SKILL.md", "team-plan`, `team-exec`, and `team-verify"],
  ["skills/omc-team/SKILL.md", "CODEX_HOME"],
  ["skills/omc-team/SKILL.md", "$codexHome"],
  ["skills/omc-ralph/SKILL.md", "node $omc start --mode ralph"],
  ["skills/omc-trace/SKILL.md", "node $omc start --mode trace"],
  ["skills/omc-ultrawork/SKILL.md", "node $omc start --mode ultrawork"],
];
